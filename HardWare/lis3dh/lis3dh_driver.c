...
void LIS3DH_Check(void){
  ...
  if((response==1) && (old_position!=position)){
	...
	//此处加入报警函数
    switch (position){
    case LIS3DH_UP_SX:      break;
    case LIS3DH_UP_DX:      break;
    case LIS3DH_DW_SX:      break;              
    case LIS3DH_DW_DX:      break; 
    case LIS3DH_TOP:        break; 
    case LIS3DH_BOTTOM:     break; 
    default:                break;
    }
